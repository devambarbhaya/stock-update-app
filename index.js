...
function fetchTopStocks() {
    // Fetch data from api
    fetch('https://www.alphavantage.co/query?function=SECTOR&apikey=68CIZ03PC3IU46ZS').then(response => response.json()).then(data => {
...
function fetchStockData(symbol) {
    ...
    fetch(`https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=68CIZ03PC3IU46ZS`).then(response => response.json()).then(data => {
